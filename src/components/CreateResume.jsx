    ...
    return(
        <section className="createResume">
            <div className="containerH2">
                <h2 className="subtitleCv" onClick={() => changeStateActive()}>⬅ Crear hoja de vida</h2>
            </div>
            <Steps></Steps>
            <article className="containerRol">
                <h3>Selecciona tu rol</h3>
                <div className="containerButton">
                    <button className="buttonSimple" onClick={() => changeRol("egresado")}>Egresado</button>
                    <button className="buttonSimple" onClick={() => changeRol("profesional")}>Profesional consolidado</button>
                </div>
            </article>
            {rol.egresado ? 
            <CarouselForm /> :
